        ...
        <div>
            ...
            <main>
                <section className="path-section container row">
                    ...
                    <p className="slash">/</p>
                    <a href="bakery.html" className="sel-cat">Bakery</a>
                    <p className="slash">/</p>
                    ...
                    <section className="info-column column">
                        <div className="title-star">
                            ...
                            <div className="star-review row">
                                ...
                                <a className="review-value" href="#">(1 customer review)</a>
                            </div>
                        </div>
                        ...
                        <div className="chara-columns row">
                            <div className="column-1 column">
                                ...
                                <div className="row">
                                    ...
                                    <a href="#" className="value">Vegetables</a>
                                </div>
                                <div className="row">
                                    <p className="name">Stock:</p>
                                    <a href="#" className="value green">In Stock</a>
                                </div>
                                <div className="row">
                        ...
                        <div className="big-description column">
                            <div className="select-row row">
                                <div className="select-btn">
                                    <input type="radio" name="radio-select" id="radio-select1" defaultChecked />
                                ...
                                <div className="select-btn">
                                    ...
                                    <label htmlFor="radio-select2" className="radio-select radio-select2 row">
                                ...
                                <div className="select-btn">
                                    ...
                                    <label htmlFor="radio-select3" className="radio-select radio-select3 row">
                    ...
                    <div className="products-row row">
                        <div className="column product-card product-card-2">
                            ...
                            <div className="price-row row">
                                ...
                                <div><a href="checkout.html" className="buy-now-btn green-btn">Buy now</a></div>
                            </div>
                        </div>
                        <div className="column product-card product-card-2">
                            <div className="img-sub">
